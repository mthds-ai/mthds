---
description: "Formal specification of pipe I/O contracts — the per-pipe map of declared input and output slots, each with its concept, presence, multiplicity and JSON Schema."
---
