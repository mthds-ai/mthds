...
| `neoteroi.mkdocsoad` | Renders OpenAPI documents into pages via `OAD` include tags (used by the protocol OpenAPI reference page; styles in `docs/stylesheets/neoteroi-oad.css`) |
