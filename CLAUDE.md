...
| `neoteroi.mkdocsoad` | Renders OpenAPI documents into pages via `[OAD(path)]` tags (used by the protocol OpenAPI reference page; styles in `docs/stylesheets/neoteroi-oad.css`) |
